...
- Imagem nativa faltando não bloqueia mais o salvamento no Elementor: passa a ser reportada como aviso ao usuário para ajuste manual posterior, enquanto erros estruturais continuam bloqueando.
